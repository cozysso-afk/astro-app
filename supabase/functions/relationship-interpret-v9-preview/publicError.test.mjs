...
const fixture={headline:'합성 해설',overview:prose,chemistry:prose,emotional_dynamic:prose,communication:prose,conflict_pattern:prose,power_boundaries:prose,long_term:prose,timing:prose,reunion_context:prose,felt_scenarios:[prose,prose,prose],practical_advice:[prose],top_aspects:[{label:'근거',meaning:prose}],limits:prose,reunion_reading:{bottom_line:prose,incoming_contact:prose},reunion_synthesis_v2:{summary:prose,why_reconnect:{conclusion:prose,interpretation:prose,evidence_refs:reunionEvidenceIds.slice(0,2)},initiative:{conclusion:prose,interpretation:prose,evidence_refs:reunionEvidenceIds.slice(1,3)},timing:{conclusion:prose,windows:[{period:'2027-01',meaning:prose,evidence_refs:reunionEvidenceIds.slice(2,4)}],evidence_refs:reunionEvidenceIds.slice(2,4)},rebuild:{conclusion:prose,conditions:[prose],evidence_refs:reunionEvidenceIds.slice(3,5)},repeat_risks:{conclusion:prose,patterns:[prose],evidence_refs:reunionEvidenceIds.slice(4,6)},convergence:[],precision_note:prose},marriage_reading:Object.fromEntries(['bottom_line','bond','emotional_home','daily_life','intimacy_resources','conflict_repair','commitment_or_current_cycle','timing','caution','precision_note'].map(k=>[k,prose]))};
