...
const topicSchema={type:"OBJECT",properties:{importance:{type:"STRING",enum:["핵심","주목","참고"]},verdict:S,reason:S,timing:S,action:S,avoid:S,confidence:{type:"STRING",enum:["높음","보통","낮음"]},confidence_reason:S,evidence_refs:refs},required:["importance","verdict","reason","timing","action","avoid","confidence","confidence_reason","evidence_refs"]};
