...
export const VERSION = "supabase-ai-v16-split-structured-output";
...
- topic_analysis는 15개 분야를 배열에 정확히 한 번씩 모두 넣고, 각 항목의 topic 필드에는 TOPICS의 분야명을 그대로 쓴다. 분야마다 verdict만 쓰지 말고 reason에 기간 평균과 월별 변화 또는 날짜 피크를 연결하되 importance=참고인 분야는 핵심 판단에 필요한 최소 설명만 쓴다.
