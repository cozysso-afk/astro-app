...
if '<div class="astro-nav-label">기간 운세</div>' in app:
    app=app.replace('<div class="astro-nav-label">기간 운세</div>','<div class="astro-nav-label">기간 선택</div>',1); changed=True
...
elif 'FORTUNE_LAB_VERSION = "v0.1.9"' not in lab:
