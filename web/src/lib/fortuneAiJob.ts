export const FORTUNE_AI_JOB_CONTRACT = 'fortune-ai-job-release-v21.3.2-relationship-direction-depth'
export const FORTUNE_AI_JOB_STORAGE_KEY = 'starlight-destiny.ai-job.v6'
