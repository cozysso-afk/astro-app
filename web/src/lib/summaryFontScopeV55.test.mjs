...
test('live integrated headline is bold Noto Serif and its supporting sentence is sans-serif', () => {
  assert.match(css, /\.period-ai-card\.period-ai-v18 \.period-ai-head h3[\s\S]*?font-family:\s*'Noto Serif KR'/)
