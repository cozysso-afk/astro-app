...
test('v42 stays below shared reading styles; viewport owns background while font fix stays final', () => {
  ...
  assert.ok(viewportOwner > owner)
  assert.ok(fontOwner > viewportOwner)
