...
test('daily fallback headline uses the strongest linked evidence as a concrete scene',()=>{
  ...
  assert.match(view.headline,/오늘 전체 흐름에서 가장 먼저 볼 건 대인관계|필요한 말이 실제 약속이나 일정/)
  assert.match(view.headline,/실제 약속이나 일정/)
