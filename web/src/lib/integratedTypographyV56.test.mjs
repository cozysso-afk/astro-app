...
test('integrated headline is bold Nanum Myeongjo while its supporting sentence is sans-serif', () => {
  assert.match(finalCss, /\.period-ai-card\.period-ai-v18 \.period-ai-head h3[\s\S]*font-family:\s*'Nanum Myeongjo'/)
