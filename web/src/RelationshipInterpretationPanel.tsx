  ...
  return <section className="relationship-experience reading-experience" data-mode={analysisMode}>
    ...
    {ai?.ok && ai.data ? <section className="reading-section relationship-natural-reading">
      ...
      {reunion && reunionAi ? <>
        ...
        {!!reunionAi.windows && <section className="reunion-ai-block"><h4>재접촉 시기</h4><p>{reunionAi.windows}</p>{!!reunionAi.low && <p className="reunion-low-window"><b>피할 구간</b>{reunionAi.low}</p>}</section>}
